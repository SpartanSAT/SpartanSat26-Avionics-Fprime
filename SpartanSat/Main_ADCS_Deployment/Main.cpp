...
#include <SpartanSat/Main_ADCS_Deployment/Top/Main_ADCS_DeploymentTopology.hpp>
// OSAL initialization
#include <Os/Os.hpp>
...
int main(int argc, char* argv[]) {
    ...
    SpartanSat::TopologyState inputs;
    ...
    SpartanSat::setupTopology(inputs);
    SpartanSat::startRateGroups(Fw::TimeInterval(1,0));  // Program loop cycling rate groups at 1Hz
    SpartanSat::teardownTopology(inputs);
    (void)printf("Exiting...\n");
    return 0;
}
