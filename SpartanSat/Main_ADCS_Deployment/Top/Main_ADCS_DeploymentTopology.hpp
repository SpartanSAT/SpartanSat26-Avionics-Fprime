// ======================================================================
// \title  Main_ADCS_DeploymentTopology.hpp
// \brief header file containing the topology instantiation definitions
//
// ======================================================================
#ifndef MAIN_ADCS_DEPLOYMENT_MAIN_ADCS_DEPLOYMENTTOPOLOGY_HPP
#define MAIN_ADCS_DEPLOYMENT_MAIN_ADCS_DEPLOYMENTTOPOLOGY_HPP
// Included for access to Main_ADCS_Deployment::TopologyState and Main_ADCS_Deployment::ConfigObjects::pingEntries. These definitions are required by the
// autocoder, but are also used in this hand-coded topology.
#include <SpartanSat/Main_ADCS_Deployment/Top/Main_ADCS_DeploymentTopologyDefs.hpp>
 ...
 * Main_ADCS_Deployment::TopologyState see: Main_ADCS_DeploymentTopologyDefs.hpp.
 *
 ...
 *
 * For an explanation of the required type SpartanSat::TopologyState see: SpartanSatTopologyDefs.hpp.
 *
